...
public class VirtualMachine
{
    ...
    public VirtualMachine(IDisplay display): this(new Decoder.Decoder(), display) { }
    
    internal VirtualMachine(): this(new Decoder.Decoder(), new NoDisplay()) { }
    
    internal VirtualMachine(IDecoder decoder, IDisplay display)
    {
        _decoder = decoder;
        Display = display;
    }
    ...
    internal void LoadRom(string filepath)
    {
        ...
        for (int i = 0, memoryIndex = 0x200; i < rom.Length; i++, memoryIndex++)
        {
